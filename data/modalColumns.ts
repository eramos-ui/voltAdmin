...
export const activityColumns: ColumnConfigType<GridRowType>[] = [
  ...
  { key: "fechaInicio", label: "Fecha inicio", captionPosition: "top", editable: true, visible: true,  type: "string",textAlign:'left', inputType: "date", width:'100px', options: undefined,
    widthFormEdit: '300px',rowFormEdit:2, labelFormEdit:'Fecha de inicio de la actividad',required: true,format: 'dd/MM/yyyy',
   },
  { key: "fechaTermino", label: "Fecha término", captionPosition: "top", editable: true, visible: true,  type: "string", inputType: "date", width:'100px', options: undefined,
    widthFormEdit: '300px',rowFormEdit:2, labelFormEdit:'Fecha de término de la actividad',required: true,format: 'dd/MM/yyyy',
   },
  { key: "duracion", label: "Duración (días)", captionPosition: "top", editable: false, visible: true,  type: "number", width:'120px', options: undefined },
  { key: "presupuesto", label: "Presupuesto", captionPosition: "top", editable: true, visible: true,  type: "number", width:'145px', options: undefined ,
    widthFormEdit: '250px',rowFormEdit:3, labelFormEdit:'Presupuesto',required: true, formatNumber:true,inputType:'number',
  },
