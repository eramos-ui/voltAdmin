...
import { FormField, FrameConfig } from '../../types/interfaces';

const buildValidationSchema = (fields: FormField[]): { [key: string]: Yup.MixedSchema } => {
...
export const getValidationSchema = (
  formData: { frames?: FrameConfig[]; fields?: FormField[] }
