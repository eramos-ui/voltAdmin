...
import { CustomInput } from "@/app/components/controls/CustomInput";
...
import { validaModalInstalacion } from "@/app/utils/validaModalInstalacion";
interface ProjectDetailsFormProps {
  ...
  optionsOrientation: { value: string; label: string }[];
          ...
          <>
            ...
            { selectedInstalacion > 0 && values.techoGrid && (
              <div className="mb-2 flex items-start space-x-2">
                  ...
                  />
                    { isEditingAguas  && (
                    <CustomModal isOpen={isEditingAguas} height="80vh" width="1200px"  onClose={() => handleCancel(isDirtyAguas, setIsEditingAguas)}  
