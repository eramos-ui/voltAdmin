...
export default function HomePage() { 
  ...
  const menuOptions = [
    ...
    { title: "Proveedores", description: "Explora y contacta proveedores de materiales y servicios.", icon: <FaIndustry /> },
    ...
    { title: "Costos y presupuestos", description: "Herramientas para estimar y controlar costos.", icon: <FaCalculator /> },
    { title: "Validación de entregables", description: "Verifica y certifica el cumplimiento de los requisitos.", icon: <FaCheckCircle /> },
    ...
    { title: "Perfil y configuración", description: "Gestiona tu cuenta y preferencias.", icon: <FaUserCog /> }
  ];
  return (
    <div className="p-6">
