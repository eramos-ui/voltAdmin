...
export const EditForm: React.FC<EditFormProps> = ({
  ...
  const { theme: themeEdit, formTitle, modalStyles } = formConfig;
  ...
  return (
    <>     
    {/* {(() => { console.log('en jsx page formConfig.editFormSize?', formConfig.editFormSize); return null; })()}  */}
      <CustomModal
        isOpen={isOpen}
        onClose={onClose}
        width={formConfig.editFormSize?.width} //height={height}
