...
export const MyTextInput = ( { 
  ...
  //const [ field ] = useField( props );//otro elemento es el meta dice si hay errores si ha sido tocado..
    ...
    //console.log('MyTextInput',style, width,{ width: `${width}` || '300px' })
  ...
  return (
    <div className="mb-4">
      ...
      <input
        ...
        //w-full
        className={` p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${className}`}
        {...field}
        {...props}
        {...inputProps}
      />
