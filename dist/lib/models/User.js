...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function (_super) {
        ...
        function User_1() {
            ...
            _this.avatar = (__runInitializers(_this, _email_extraInitializers), __runInitializers(_this, _avatar_initializers, void 0));
            _this.theme = (__runInitializers(_this, _avatar_extraInitializers), __runInitializers(_this, _theme_initializers, void 0));
            __runInitializers(_this, _theme_extraInitializers);
            return _this;
        }
        return User_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _theme_decorators = [(0, sequelize_typescript_1.Column)({
                type: sequelize_typescript_1.DataType.STRING,
                allowNull: false,
            })];
